...
TextRSAPrivateKey plainPrivateKeyObject = new PlainTextRSAPrivateKey(plainPrivateKey);
TextRSAPublicKey plainPublicKeyObject = new PlainTextRSAPublicKey(plainPublicKey);
...
String jwt = JWTSigner.sign(plainPrivateKeyObject, plainPublicKeyObject, jwtBuilder);
...
TextRSAPrivateKey privateKeyObjectPlain = new PlainTextRSAPrivateKey(privateKeyPlain);
TextRSAPublicKey publicKeyObjectPlain = new PlainTextRSAPublicKey(publicKeyPlain);
...
String jwt = JWTSigner.sign(privateKeyObjectPlain, publicKeyObjectPlain, jwtBuilder);
